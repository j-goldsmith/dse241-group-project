...
westNileMap.legend = function(){
    ...
    function build(){
      // var svgElement = rootContainer.append('svg');
      // svgElement.append('g').attr('class','seasons');
      // svgElement.append('g').attr('class','cases');
        ...
        /*rootContainer.append('text')
            .attr('class','display-4 legend-title')
            .attr('x','50%')
            .attr('y','55%')
            .attr('text-anchor','middle')
            .attr('alignment-baseline',"middle" )
...
westNileMap.map = function(){
    ...
    function draw(){
        ...
        rootContainer.select('text.display-4')
            ...
            .attr('transform','translate('+dimensions.width * 2.3 / 12+','+dimensions.height*6.8/7+')')
            .html(function(){
